...
enum AppAuthorization {
  ...
  private static func resolve(live: AuthorizationStatus, cached: AuthorizationStatus?)
    -> AuthorizationStatus
  {
  ...
  private static func payload(reminders: AuthorizationStatus, calendars: AuthorizationStatus)
    -> AuthStatusPayload
  {
    AuthStatusPayload(
      reminders: reminders,
